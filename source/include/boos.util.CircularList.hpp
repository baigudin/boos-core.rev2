 ...
 */
#ifndef BOOS_UTIL_CIRCULAR_LIST_HPP_
#define BOOS_UTIL_CIRCULAR_LIST_HPP_
...
{  
  ...
  class CircularList : public AbstractLinkedList<Type,Alloc>
  {
    typedef AbstractLinkedList<Type,Alloc>  Parent;
  ...
  private:
    ...
    public:
      ...
      {
        return hasPrev() ? curs_->prev()->index() : -1;
      }
    ...
    private:
      ...
      bool construct(int32 index)
      {
        ...
        if(index == last_->index() + 1) index = 0;
...
#endif // BOOS_UTIL_CIRCULAR_LIST_HPP_
