...
; ----------------------------------------------------------------------------
    ...
    .def  _globalDisableLow__Q2_6target19InterruptControllerSFv
    .def  _globalEnableLow__Q2_6target19InterruptControllerSFb
    ...
    .asg  ___bss__,                                              m_bss
    .asg  _globalDisableLow__Q2_6target19InterruptControllerSFv, m_global_disable
    .asg  _globalEnableLow__Q2_6target19InterruptControllerSFb,  m_global_enable
...
m_core_reset:
        ...
        mvc             b0, csr
        mvkl            m_core_start, b0
        mvkh            m_core_start, b0
        b               b0
        nop             5
